          ...
          <div class="page-title-box">
            <div class="btn-group pull-right">
              <ol class="breadcrumb hide-phone p-0 m-0">
                ...
                <li class="breadcrumb-item active">Con Clases Perdidas</li>
              </ol>
            </div>
            <h4 class="page-title">Alumnos con clases perdidas</h4>
          </div>
        </div>
      </div>
      ...
      $("#grados").change(function(){
        ...
        $.ajax({
          ...
          success:  function (response) {
            ...
            tabla += '<th>Seccion</th>';
            tabla += '<th>Clave</th>';
            tabla += '<th class="vText">Promedio</th>';
            tabla += '<th class="vText">Puntos Acumulados</th>';
            tabla += '<th class="vText" >Bloque I</th>';
            tabla += '<th class="vText" >Bloque II</th>';
            tabla += '<th class="vText" >Bloque III</th>';
            tabla += '<th class="vText" >Bloque IV</th>';
            tabla += '<th class="vText" >Total Clases Perdidas</th>';
            ...
            $.ajax({
              ...
              success:  function (finales) {
                ...
                for (var a = 1; a <= calum; a++){
                  ...
                  tr += '<td>'+finales[a-1]['clave']+'</td>';
                  tr += '<td>'+finales[a-1]['pro']+'</td>';
                  tr += '<td>'+finales[a-1]['pun']+'</td>';
                  tr += '<td>'+finales[a-1]['cp1']+'</td>';
                  tr += '<td>'+finales[a-1]['cp2']+'</td>';
                  tr += '<td>'+finales[a-1]['cp3']+'</td>';
                  tr += '<td>'+finales[a-1]['cp4']+'</td>';
                  tr +='<td><span class="badge badge-pill badge-danger">'+finales[a-1]['cpt']+'</span></td>';
