...
class PDF extends TCPDF{
	...
	function Footer(){
		...
		$this->Cell(0,10," LIA | IMED | "."Ref # ".$this->getAliasNumPage().'/'.$this->getAliasNbPages(),0,0,'C');
	}
}
...
while ($aa=mysqli_fetch_array($queryg)) {
	...
	*/
	...
	$pdf->Cell(190,4,"f._________________________________________",0,0,'C');
	$pdf->Ln(4);
	$pdf->Cell(190,4,"Lic. Tomas Ramiro López Matías",0,0,'C');
	$pdf->Ln(4);
	$pdf->Cell(190,4,"Director del Establecimiento",0,0,'C');
	$pdf->Ln(10);
/*
