...
class PDF extends FPDF{
	function Header(){
		global $uniqid, $table, $mes, $nombregrado, $seccion,$columnas,$titulo,$anchoc,$logobn,$abrcole;
		...
		$this->Ln(10);
		$this->Cell(190,10,utf8_decode($titulo),"L",0,'L');
		$this->Ln(15);
		$this->SetDrawColor(0,0,0);
		$this->SetFont("Helvetica","B",7);
		$this->Cell(10,10,"Clave",1,0,'L');
		$this->Cell(60,10,"Alumno",1,0,'C');
		for ($i=1; $i <=$columnas ; $i++) {
			$this->Cell($anchoc,10,"",1,0,'L');
		}
		$this->Ln(10);
	}
	function recorrer(){
	...
	function Footer(){
		...
		$this->Cell(190,4,utf8_decode("LIA - System of Learning, Investigation and Advanced School Management - JH Developer"." - ".date("d-m-Y h:s a")),0,0,'C');
	}
}
...
$sql="SELECT * FROM `alumnos` WHERE idcole='$idcole' AND idgrado='$idgrado' ORDER BY apellidos";
