              ...
              <div class="tab-pane fade active show" id="home">
                <div class="row">
                  <div class="col-md-3">
                    ...
                    echo '
                    <select    id="grado1" class="form-control select2">
                  ...
                  <div class="col-md-3">
                    <button type='button' class='gen1 add btn btn-simple btn-danger btn-icon' data-toggle='modal' data-target='#datos' title='Agregar un nuevo alumno' ><i class=' mdi mdi-file-pdf  '></i> Generar</button>
                  </div>
                </div>
              </div>
...
function asistencia(){
  var idgrado=$("#grado1").val();
  var seccion=$('#secciones1').val();
  var mes=$("#mes").val();
  var r=1;
  if (idgrado=="none") {
    swal({
  ...
  if (mes=="none") {
    swal({
      title: "Campo Requerido",
      text: "Necesita Selecionar Un Mes",
      icon: "warning",
    });
    r=0;
  }
  if (r==1) {
    if (seccion=="All") {
      ...
      var url="../reportes/asistenciagradosinseccion.php?grado="+grado;
      $("#iframe").attr("src", url);
    }else {
      var grado=idgrado+"-"+seccion+"-"+mes;
