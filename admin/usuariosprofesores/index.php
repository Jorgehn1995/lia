        ...
        <div class="col-md-10">
          <div class="card-box">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  <label for="nombres"  class="control-label text-muted">Usuario del profesor</label>
                  <input type="text" id="usuario" class="form-control" name="" value="">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="nombres" class="control-label text-muted">Acceso</label>
                  <div id="acceso">
