...
<head>
  <meta charset="utf-8" />
  <?php $titulo="Profesores"; include '../lib/header.php'; ?>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            <button type='button' class='info add btn btn-simple btn-success btn-icon' data-toggle='modal' data-target='#datos' title='Agregar un nuevo alumno' ><i class=' ti-plus '></i> Agregar Profesor</button>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-12">
          <div class="card-box">
            <div class="text-center">
              <h5>Sin profesores en la base de datos</h5>
            </div>
          </div>
        </div>
      </div>
    ...
    function cargar(){
      ...
      $.ajax({
        ...
        success:  function (response) {
          //alert(response);
          if (response>0) {
            var btn1 = "<button type='button' class='edit btn btn-warning btn-sm waves-effect waves-light m-b-5' title='Editar' ><i class=' ti-pencil-alt '></i></button></div>"
