...
class PDF extends FPDF
{
	function Footer()
	{
		...
		$this->Cell(0,10,"Sistema LIA | www.imnedcoop.com | Usuario Profesor | "."Pagina ".$this->PageNo()."/{nb}",0,0,'C');
	}
}
...
$pdf->Cell(34,8,'',0);
$pdf->Cell(250,8,utf8_decode('Instituto Mixto de Educación Diversificada por Cooperativa IMED'),0,0,'C');
//$pdf->Cell(50,9,,0,0,'R');
$pdf->Ln(8);
...
$pdf->SetFont("Helvetica","B",14);
$pdf->Cell(34,3,'',0);
$pdf->Cell(250,3,utf8_decode("$ngrado $sec"),0,0,'C');
$pdf->Ln(8);
$pdf->SetFont("times","",11);
$pdf->Cell(34,3,'',0);
$pdf->Cell(15,10,"Materia: ",0);
$pdf->SetFont("times","BI",11);
$pdf->Cell(100,10,utf8_decode($nclase),0);
$pdf->SetFont("times","",11);
...
$pdf->Cell(100,10,utf8_decode($pn),0);
$pdf->Ln(10);
$pdf->SetFont("times","BI",11);
...
if ($resultado) {
	while( $data = mysqli_fetch_array($resultado)){
		...
		$pdf->Cell(75,5,utf8_decode($nombre),1,0,'L');
...
$pdf->Output("IMED Bloque ".utf8_decode("$bloque - $ngrado $sec - $nclase").".pdf",'I');
?>
