...
<body>
  ...
  <div class="wrapper">
    <div class="head">
      <div class="row">
        <div class="col-md-12">
          <h2 class="text-light"><b>Cuadros</b> <small><small> > Bloque I</small></small> </h2>
        </div>
        <div class="col-md-12">
          <p class="text-light">Tecnologías de la Información y la Comunicación > Cuarto Magisterio Infantil </p>
        </div>
        <div class="col-md-12">
          <div class="form-group">
            <button type="button" class="btn btn-outline-light btn-change" name="button">Cambiar Cuadro</button>
          </div>
          <div class="form-group">
  ...
  <div id="change" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal">Cerrar</button>
          <button type="button" class="btn btn-primary waves-effect waves-light ">Mostrar Cuadro</button>
        </div>
      </div>
    </div>
  </div><!-- /.modal -->
