...
function change($idpersonal,$idnota,$notanueva){
  ...
  */
  ...
  $sql="SELECT * FROM `notas` WHERE idnota='$idnota' LIMIT 1";
  ...
  if ($query->num_rows==0) {
    ...
    $sql2="INSERT INTO `cambiosennotas`( `idpersonal`, `notaanterior`, `msg`, `notanueva`, `idnota`, `idalumno`, `idmateria`, `bloque`, `idmodelo`, `hora`) VALUES ('$idpersonal','$notaanterior','$msg','$notanueva','$idnota','$idalumno','$idmateria','$bloque','$modelo','$datetime')";
...
$sql="UPDATE `notas` SET obtenido='$punteo' WHERE idnota='$idcuadro'";
