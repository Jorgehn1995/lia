                ...
                <table id="datatables" class="table table-bordered table-striped table-hover"  cellspacing="0" cellpadding="0" width="100%" >
                  <thead>
                    <tr>
                      ...
                      <th class="" data-toggle="tooltip" data-placement="top" title="Saber Emprender"  width="4%" rowspan="2">Empren.</th>
                    </tr>
                    <tr>
                      <th width="3%">Clave</th>
                      <th width="20%">Nombre</th>
                      <th class="" data-toggle="tooltip" data-placement="top" title="Examen"  width="6%">Examen</th>
                      <th class="" data-toggle="tooltip" data-placement="top" title="Parcial"  width="6%">Parcial</th>
                      <th class="" width="6%">Hacer1</th>
                      <th class="" width="6%">Hacer2</th>
                      <th class="" width="6%">Hacer3</th>
                      <th class="" width="6%">Hacer4</th>
                      <th class="" width="6%">Hacer5</th>
                      <th class="" data-toggle="tooltip" data-placement="top" title="Entra Puntual a Clases y Sabe Escuchar" width="6%">Saber Escuchar</th>
                      <th class="" data-toggle="tooltip" data-placement="top" title="Usa Correcto el Uniforme" width="6%">Uniforme</th>
                      <th class="" data-toggle="tooltip" data-placement="top" title="Respeta y usa vocabulario adecuado" width="6%">Respeto</th>
                      <th class="" data-toggle="tooltip" data-placement="top" title="Higiene" width="6%">Higiene</th>
                      <th class="" data-toggle="tooltip" data-placement="top" title="Integracion Familiar" width="6%">Integ.</th>
