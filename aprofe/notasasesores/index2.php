...
<body>
  ...
  $(document).ready(function(){
    ...
    $("#grados").change(function(){
      ...
      table.on('keypress', '.datagrid', function(tecla) {
        console.log(tecla.keyCode);
        if (tecla.keyCode==39) {
          $(this).parent("td").next().find(".datagrid").focus()
        }
        if (tecla.keyCode==37) {
          $(this).parent("td").prev().find(".datagrid").focus()
        }
        if (tecla.keyCode==40) {
          var dataid=$(this).attr("id");
          $(this).parent("td").parent().next().find("#"+dataid).focus()
        }
        if (tecla.keyCode==38) {
          var dataid=$(this).attr("id");
          $(this).parent("td").parent().prev().find("#"+dataid).focus()
        }
      });
